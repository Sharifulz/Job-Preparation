...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="https://www.facebook.com/airconnectionofficial/?ref=br_rs" target="blank">
                    <i class="fa fa-comment-o fa-2x text-danger"></i></a>
                <span style="margin: 10px;">Official Page</span>
        ...
        <div class="row bg-danger">
            ...
            <div class="col-md-7">
                <ul>
                    <li><a href="redirectSignin.py">SIGN IN</a></li> <!-- controller name [com.exam.controller.NavigationController] -->
                    <li><a href="#contactForm">CONTACTS</a></li> 
                    <li><a href="mainPage.py">HOME</a></li><!-- controller name [com.exam.controller.NavigationController] -->
                </ul>
            </div>
        </div>
</div>
